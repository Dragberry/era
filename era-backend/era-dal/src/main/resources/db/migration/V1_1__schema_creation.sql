...
CREATE TABLE REG_PERIOD_SPECIALTY (
	REGISTRATION_PERIOD_KEY BIGINT NOT NULL,
	SPECIALTY_KEY BIGINT NOT NULL,
	PRIMARY KEY(REGISTRATION_PERIOD_KEY, SPECIALTY_KEY),
	CONSTRAINT FK_REG_PERIOD_SPECIALTY FOREIGN KEY (REGISTRATION_PERIOD_KEY) REFERENCES REGISTRATION_PERIOD (REGISTRATION_PERIOD_KEY),
	CONSTRAINT FK_SPECIALTY_EINSTITUTION FOREIGN KEY (SPECIALTY_KEY) REFERENCES SPECIALTY (SPECIALTY_KEY)
) ENGINE=INNODB;
...
CREATE TABLE REGISTRATION (
	...
	REGISTRATION_TYPE CHAR(1) NOT NULL,
	REGISTRATION_PERIOD_KEY BIGINT NOT NULL,
	...
	CONSTRAINT CHK_REGISTRATION_TYPE CHECK (REGISTRATION_TYPE IN ('B', 'P'))
) ENGINE=INNODB;
