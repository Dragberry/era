...
CREATE TABLE AUDIT_RECORD (
	...
	REFERENCED_ENTITY_KEY BIGINT,
	ACTION CHAR(1) NOT NULL,
	CHANGES TEXT,
	PRIMARY KEY (AUDIT_RECORD_KEY),
	CONSTRAINT FK_AUDIT_RECORD_UA FOREIGN KEY (USER_ACCOUNT_KEY) REFERENCES USER_ACCOUNT (USER_ACCOUNT_KEY),
	CONSTRAINT CHK_AUDIT_ACTION CHECK (STATUS IN ('S', 'V', 'N', 'U', 'D'))
) ENGINE=INNODB;
...
CREATE TABLE REGISTERED_SPECIALTY (
	...
	EXAM_SUBJECT_EXPRESSION VARCHAR(128),
	VERSION BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE PERSON (
	...
	ID VARCHAR(14),
	DOCUMENT_ID VARCHAR(9),
	DOCUMENT_ISSUE_DATE DATE,
	DOCUMENT_ISSUED_BY VARCHAR(64),
	CITIZENSHIP CHAR(2),
...
CREATE TABLE EDUCATION_INSTITUTION_BASE (
	EDUCATION_INSTITUTION_BASE_KEY BIGINT NOT NULL,
	NAME VARCHAR(128) NOT NULL,
	COUNTRY CHAR(2) NOT NULL,
	VERSION BIGINT NOT NULL DEFAULT 0,
	PRIMARY KEY (EDUCATION_INSTITUTION_BASE_KEY),
	UNIQUE INDEX (NAME, COUNTRY)
) ENGINE=INNODB;

CREATE TABLE CERTIFICATE (
	CERTIFICATE_KEY BIGINT NOT NULL,
	EDUCATION_INSTITUTION_BASE_KEY BIGINT,
	YEAR INT,
	ENROLLEE_KEY BIGINT NOT NULL,
	VERSION BIGINT NOT NULL DEFAULT 0,
	PRIMARY KEY (CERTIFICATE_KEY),
	CONSTRAINT FK_CERTIFICATE_PERSON FOREIGN KEY (ENROLLEE_KEY) REFERENCES PERSON (PERSON_KEY),
	CONSTRAINT FK_CERTIFICATE_EIB FOREIGN KEY (EDUCATION_INSTITUTION_BASE_KEY) REFERENCES EDUCATION_INSTITUTION_BASE (EDUCATION_INSTITUTION_BASE_KEY)
) ENGINE=INNODB;
...
CREATE TABLE EXAM_SUBJECT (
	EXAM_SUBJECT_KEY BIGINT NOT NULL,
	CODE CHAR(2),
	TITLE VARCHAR(64) NOT NULL,
	VERSION BIGINT NOT NULL DEFAULT 0,
	PRIMARY KEY (EXAM_SUBJECT_KEY),
	UNIQUE INDEX (TITLE),
	UNIQUE INDEX (CODE)
) ENGINE=INNODB;
...
CREATE TABLE REGISTRATION (
	...
	REGISTRATION_PERIOD_KEY BIGINT NOT NULL,
	ENROLLEE_KEY BIGINT NOT NULL,
	ENROLLEE_AS_PAYER BIT NOT NULL DEFAULT FALSE,
	PAYER_KEY BIGINT,
	...
	CONSTRAINT FK_REGISTRATION_PA FOREIGN KEY (PAYER_KEY) REFERENCES PERSON (PERSON_KEY),
	CONSTRAINT FK_REGISTRATION_RUA FOREIGN KEY (REGISTERED_BY) REFERENCES USER_ACCOUNT (USER_ACCOUNT_KEY),
	CONSTRAINT FK_REGISTRATION_VUA FOREIGN KEY (VERIFIED_BY) REFERENCES USER_ACCOUNT (USER_ACCOUNT_KEY),
...
CREATE TABLE REGISTRATION_EXAM_SUBJECT (
	REGISTRATION_KEY BIGINT NOT NULL,
	EXAM_SUBJECT_KEY BIGINT NOT NULL,
	MARK TINYINT NOT NULL,
	PRIMARY KEY (REGISTRATION_KEY, EXAM_SUBJECT_KEY),
	CONSTRAINT FK_REG_REG_EXS FOREIGN KEY (REGISTRATION_KEY) REFERENCES REGISTRATION (REGISTRATION_KEY),
	CONSTRAINT FK_EXS_REG_EXS FOREIGN KEY (EXAM_SUBJECT_KEY) REFERENCES EXAM_SUBJECT (EXAM_SUBJECT_KEY)
) ENGINE=INNODB;
...
CREATE TABLE REGITRATION_CONTRACTS (
	EDUCATION_INSTITUTION_KEY BIGINT NOT NULL,
	REPORT_TEMPLATE_KEY BIGINT NOT NULL,
	FUNDS_SOURCE CHAR(1) NOT NULL,
	PRIMARY KEY (EDUCATION_INSTITUTION_KEY, REPORT_TEMPLATE_KEY, FUNDS_SOURCE),
	CONSTRAINT FK_REG_CONTRACT_EI FOREIGN KEY (EDUCATION_INSTITUTION_KEY) REFERENCES EDUCATION_INSTITUTION (EDUCATION_INSTITUTION_KEY),
	CONSTRAINT FK_REG_CONTRACT_RP FOREIGN KEY (REPORT_TEMPLATE_KEY) REFERENCES REPORT_TEMPLATE (REPORT_TEMPLATE_KEY),
	CONSTRAINT CHK_REG_CON_FUNDS_SOURCE CHECK (FUNDS_SOURCE IN ('B', 'P'))
) ENGINE=INNODB;