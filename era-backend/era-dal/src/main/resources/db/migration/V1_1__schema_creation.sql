...
CREATE TABLE REG_PERIOD_SPECIALITY (
	REGISTRATION_PERIOD_KEY BIGINT NOT NULL,
	SPECIALITY_KEY BIGINT NOT NULL,
	PRIMARY KEY(REGISTRATION_PERIOD_KEY, SPECIALITY_KEY),
	CONSTRAINT FK_REG_PERIOD_SPECIALITY FOREIGN KEY (REGISTRATION_PERIOD_KEY) REFERENCES REGISTRATION_PERIOD (REGISTRATION_PERIOD_KEY),
