...
INSERT INTO SPECIALTY (SPECIALTY_KEY, CODE, TITLE, STATUS)
	VALUES ((SELECT MAX(GEN_VALUE) FROM GENERATOR WHERE GEN_NAME = 'SPECIALTY_GEN'), '2 39 02 32', 'Проектирование и производство радиоэлектронных средств', 'A');
UPDATE GENERATOR SET GEN_VALUE = GEN_VALUE + 1 WHERE GEN_NAME = 'SPECIALTY_GEN';
INSERT INTO SPECIALTY (SPECIALTY_KEY, CODE, TITLE, STATUS)
	VALUES ((SELECT MAX(GEN_VALUE) FROM GENERATOR WHERE GEN_NAME = 'SPECIALTY_GEN'), '2 39 02 31', 'Техническая эксплуатация радиоэлектронных средств', 'A');
UPDATE GENERATOR SET GEN_VALUE = GEN_VALUE + 1 WHERE GEN_NAME = 'SPECIALTY_GEN';
INSERT INTO SPECIALTY (SPECIALTY_KEY, CODE, TITLE, STATUS)
	VALUES ((SELECT MAX(GEN_VALUE) FROM GENERATOR WHERE GEN_NAME = 'SPECIALTY_GEN'), '2 40 02 02', 'Электронные вычислительные средства', 'A');
UPDATE GENERATOR SET GEN_VALUE = GEN_VALUE + 1 WHERE GEN_NAME = 'SPECIALTY_GEN';
INSERT INTO SPECIALTY (SPECIALTY_KEY, CODE, TITLE, STATUS)
	VALUES ((SELECT MAX(GEN_VALUE) FROM GENERATOR WHERE GEN_NAME = 'SPECIALTY_GEN'), '2 41 01 02', 'Микро- и наноэлектронные технологии и системы', 'A');
UPDATE GENERATOR SET GEN_VALUE = GEN_VALUE + 1 WHERE GEN_NAME = 'SPECIALTY_GEN';
INSERT INTO SPECIALTY (SPECIALTY_KEY, CODE, TITLE, STATUS)
	VALUES ((SELECT MAX(GEN_VALUE) FROM GENERATOR WHERE GEN_NAME = 'SPECIALTY_GEN'), '2 40 01 01', 'Программное обеспечение информационных технологий', 'A');
UPDATE GENERATOR SET GEN_VALUE = GEN_VALUE + 1 WHERE GEN_NAME = 'SPECIALTY_GEN';
INSERT INTO SPECIALTY (SPECIALTY_KEY, CODE, TITLE, STATUS)
	VALUES ((SELECT MAX(GEN_VALUE) FROM GENERATOR WHERE GEN_NAME = 'SPECIALTY_GEN'), '2 39 03 02', 'Программируемые мобильные системы', 'A');
UPDATE GENERATOR SET GEN_VALUE = GEN_VALUE + 1 WHERE GEN_NAME = 'SPECIALTY_GEN';
